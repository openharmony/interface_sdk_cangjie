...
public interface Zoom <: ZoomQuery {
    ...
    * Sets zoom ratio.
    *
    * @returns { Float32 } Target zoom ratio.
    * @throws { BusinessException } 7400103 - Session not config.
...
public class CameraInput <: RemoteDataLite {
    ...
    *
    * @param { CameraEvents } event - Event type.
    ...
    */
    ...
    public func on(event: CameraEvents, camera: CameraDevice, callback: Callback1Argument<BusinessException>): Unit
    ...
    */
    ...
    public func off(event: CameraEvents, camera: CameraDevice, callback: Callback1Argument<BusinessException>): Unit
...
public class PhotoSession <: RemoteDataLite & Session & Flash & AutoExposure & Focus & Zoom & ColorManagement {
    ...
    */
    ...
    public func on(event: CameraEvents, callback: Callback1Argument<BusinessException>): Unit
    ...
    */
    ...
    public func off(event: CameraEvents, callback: Callback1Argument<BusinessException>): Unit
...
public class PhotoOutput <: RemoteDataLite & CameraOutput {
    ...
    * @throws { BusinessException } 401 - The parameter check failed.
    * @throws { BusinessException } 7400201 - Camera service fatal error.
    * @relation off(type: 'estimatedCaptureDuration', callback?: AsyncCallback<int>): void
    */
    @!APILevel[
        21,
        stagemodelonly: true,
