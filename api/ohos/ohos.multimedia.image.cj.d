...
public class ImageCreator <: RemoteDataLite {
    ...
    *
    * @relation queueImage(image: Image): Promise<void>
    */
    @!APILevel[
        21,
        stagemodelonly: true,
...
* @relation function createImageCreator(size: Size, format: ImageFormat, capacity: int): ImageCreator
*/
@!APILevel[
    21,
    stagemodelonly: true,
...
public class ImagePacker <: RemoteDataLite {
    ...
    * @throws { BusinessException } 401 - If the parameter is invalid.
...
* @param { SourceOptions } options - The config of Image source.
* @relation function CreateIncrementalSource(buf: ArrayBuffer, options?: SourceOptions): ImageSource
*/
@!APILevel[
    21,
    stagemodelonly: true,
