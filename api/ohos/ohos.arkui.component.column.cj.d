...
*
* @relation const Column: ColumnInterface
*/
@!APILevel[
    21,
    stagemodelonly: true,
...
public class Column <: ContainerBase {
    /**
    * Column constructor.
    *
    * @param { Length } space
    ...
    * @returns { Column }
    * @relation alignItems(value: HorizontalAlign): ColumnAttribute
    */
    @!APILevel[
        21,
        stagemodelonly: true,
    ...
    * @returns { Column }
    * @relation justifyContent(value: FlexAlign): ColumnAttribute
    */
    @!APILevel[
        21,
        stagemodelonly: true,
